    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        ...
                        validators=[
                            ...
                            django.core.validators.MaxValueValidator(0.95),
                        ],
                    ),
                ),
                (
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="options_allocation",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "connection_type",
                    models.CharField(
                        choices=[("TASTYTRADE", "TastyTrade")], default="TASTYTRADE", max_length=20
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Use TastyTrade sandbox environment instead of production. Requires separate OAuth credentials for sandbox accounts. All orders are executed normally in the selected environment.",
                    ),
                ),
                (
                    "is_token_valid",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_automated_trading_enabled",
                    models.BooleanField(
                        default=False,
                        help_text="Enable daily automated trading for this account (executes 30 min after market open)",
                    ),
                ),
                (
                    "automated_entry_offset_cents",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "privacy_mode",
                    models.BooleanField(
                        default=False, help_text="Hide account balance on dashboard when enabled"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "buying_power",
                    models.DecimalField(
                        decimal_places=2, help_text="Available buying power", max_digits=15
                    ),
                ),
                (
                    "balance",
                    models.DecimalField(
                        decimal_places=2, help_text="Total account balance", max_digits=15
                    ),
                ),
                (
                    "source",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "account_number", "-created_at"],
                        name="accounts_ac_user_id_9cb1ec_idx",
                    )
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "is_primary"], name="accounts_tr_user_id_60e36f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tradingaccount",
